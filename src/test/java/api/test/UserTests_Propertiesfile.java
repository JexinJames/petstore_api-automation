...
public class UserTests_Propertiesfile {
	...
	public void testCreateUser() {
		...
		Response response =UserEndpoints_Propertiesfile.createUser(user_payload);
	...
	public void testGetUser() {
		...
		Response response =UserEndpoints_Propertiesfile.getUser(user_payload.getUsername());
	...
	public void testUpdateUser(){
		...
		Response response =UserEndpoints_Propertiesfile.updateUser(user_payload.getUsername(), user_payload);
	...
	public void testDeleteUser() {
		...
		Response response =UserEndpoints_Propertiesfile.deleteUser(user_payload.getUsername());
